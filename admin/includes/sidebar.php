...
<aside class="w-64 bg-gray-900 text-white min-h-screen flex flex-col">
    ...
    <nav class="flex-1 p-4 space-y-2 overflow-y-auto">
        <a href="index.php" class="flex items-center space-x-3 px-4 py-3 rounded-lg <?= $current_page === 'index.php' || $current_page === 'dashboard.php' ? 'bg-red-600' : 'hover:bg-gray-800' ?> transition">
            <span>📊</span>
            <span>Dashboard</span>
        </a>
        ...
        <a href="hero-banner.php" class="flex items-center space-x-3 px-4 py-3 rounded-lg <?= $current_page === 'hero-banner.php' ? 'bg-red-600' : 'hover:bg-gray-800' ?> transition">
            <span>🌅</span>
        ...
        <a href="product-upload.php" class="flex items-center space-x-3 px-4 py-3 rounded-lg <?= $current_page === 'product-upload.php' ? 'bg-red-600' : 'hover:bg-gray-800' ?> transition">
            <span>📤</span>
